    ...
    case ModeACCROSS:
        {
            ...
            DIRECTION dir2;
            ranSeed == 0
                ? (x = LEFT, y = interval, z = adjustedRight - interval, dir = DirRIGHTDOWN)
                : (x = LEFT + interval, y = adjustedRight, z = -interval, dir = DirRIGHTUP);
...
void River::DrawStraightLine(const int& distance, const DIRECTION& dir, List<Coordinate>& inputList,
                             Coordinate& curCoord)
{
